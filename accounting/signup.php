    ...
    <div class="container py-5 h-100">
        <div class="row d-flex align-items-center justify-content-center h-100">
            ...
            <div class="col-md-7 col-lg-5 col-xl-5 offset-xl-1">
                <form id="signupForm">
                    <p class="text-center h1 fw-bold mb-4 mx-1 mx-md-3 mt-3">Signup</p>

                    <!-- Name input -->
                    <div class="form-outline mb-4">
                        <label class="form-label" for="form1Example13"> <i class="bi bi-person-circle"></i> Name</label>
                    ...
                    <!-- Username input -->
                    <div class="form-outline mb-4">
                        <label class="form-label" for="form1Example14"><i class="bi bi-person-circle"></i> Username</label>
                    ...
                    <!-- Email input -->
                    <div class="form-outline mb-4">
                        <label class="form-label" for="form1Example15"><i class="bi bi-envelope-fill"></i> Email</label>
                   ...
                   <!-- Password input -->
                    ...
                    <div class="form-outline mb-4">
                        <label class="form-label" for="form1Example24"><i class="bi bi-lock-fill"></i> Confirm Password</label>
                    ...
                    <div class="d-flex justify-content-center">
                        <button type="submit" class="btn btn-primary btn-lg py-3 px-5" style="width:100% ; border-radius: 30px; font-weight:600;">Signup</button>
                    </div>
