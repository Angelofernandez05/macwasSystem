        ...
        <ul class="nav-links">
            ...
            <li>
                <a href="pending.php" class="position-relative">
                    <i class='bx bx-time' style="background: linear-gradient(45deg, #ff6f61, #f7b42c); -webkit-background-clip: text; color: green;"></i>
            ...
            <li>
                <a href="reports.php">
                    <i class='bx bx-bar-chart-alt' style="background: linear-gradient(45deg, #ff6f61, #f7b42c); -webkit-background-clip: text; color: green;"></i>
