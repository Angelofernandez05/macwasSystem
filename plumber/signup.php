...
<section class="vh-100">
    <div class="container py-5 h-100">
        <div class="row d-flex align-items-center h-100">
            <div class="col-md-7 col-lg-5 col-xl-5 text-start">
                <div class="signup-box">
                    ...
                    <p class="text-center h1 fw-bold mb-4 mx-1 mx-md-3 mt-3">
                        <img src="plumber.png" alt="plumber Icon" style="width: 60px; height: 60px;">
                    </p>
                    ...
                    <form id="signupForm" action="signup_process.php" method="POST">
                        ...
                        <div class="form-outline mb-4">
                            ...
                            <div class="input-group">
                                ...
                                <input required pattern="[9][0-9]{9,10}" maxlength="11" aria-describedby="phone" type="text" name="phone" class="form-control form-control-lg py-3" style="border-radius:25px ;" placeholder="Enter your phone number">
                            </div>
